// app/(admin)/admin/berita/[id]/EditBeritaClient.tsx
'use client'
...
export default function EditBeritaClient({ berita }: { berita: Berita }) {
  ...
  const [form, setForm] = useState({
    judul: berita.judul, konten: berita.konten, kategori: berita.kategori,
    excerpt: berita.excerpt ?? '', tags: berita.tags.join(', '),
    isPublished: berita.isPublished, isPinned: berita.isPinned, fotoUrl: berita.fotoUrl ?? '',
  })
  ...
  const handleSave = async (publish?: boolean) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setTimeout(() => router.push('/admin/berita'), 800)
      } else {
          ...
          <div className="p-5">
            {previewFoto ? (
              <div className="relative group">
                <Image src={previewFoto} alt="Cover berita" width={800} height={300}
        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-5 space-y-3">
            <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border border-gray-200">
              <span className={`w-2 h-2 rounded-full ${form.isPublished ? 'bg-green-500' : 'bg-gray-400'}`} />
