      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex flex-col items-center gap-2">
            <div className="w-16 h-16 bg-linear-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg shadow-green-200">
              <span className="text-white font-bold text-2xl">SD</span>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-gray-900">SIDESAA</h1>
